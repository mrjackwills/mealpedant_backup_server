...
#RUN wget https://github.com/mrjackwills/mealpedant_backup_server/releases/download/v0.0.1/mealpedant_backup_server_linux_x86_musl.tar.gz \
#	&& tar xzvf mealpedant_backup_server_linux_x86_musl.tar.gz mealpedant_backup_server && mealpedant_backup_server_linux_x86_musl.tar.gz \
